...
const config: Config = {
  ...
  organizationName: 'leshicodes', // Usually your GitHub org/user name.
  projectName: 'leshicodes.github.io', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/leshicodes/leshicodes.github.io/tree/main',
        },
        blog: {
