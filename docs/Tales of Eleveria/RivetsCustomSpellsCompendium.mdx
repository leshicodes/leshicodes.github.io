---
title: Rivet's Custom Spells Compendium
authors: [james]
description: A compendium of custom spells designed for Rivet, an Artificer/Rogue character, blending arcane innovation with mechanical ingenuity.
date: 2025-04-10
# image: /img/recipes/recipe-name.jpg
draft: false
---

# Rivet's Custom Spells Compendium
...
|------------|-------|--------|--------------|-------|------------|----------|
| [Rivet's Voltic Conflagration](#rivets-voltic-conflagration) | 3rd | Evocation | 1 action | 120 ft | V, S, M (*a copper coil wrapped around a quartz crystal*  ) | Instantaneous |
...
![Rivet's Voltic Conflagration Image](./static/RivetsVoltaticConflaguration.png)
