...
| [Rivet's Astral Wraps](#rivets-astral-wraps) | Rare | Active | Gio | Completed |
{/* | [Spell Refueling Ring](#spell-refueling-ring) | Rare | Active | Zerkzies | Completed | */}
...
**Ki Blink**  
When you use [***Step of the Wind***](https://5e.tools/classes.html#monk_xphb,state:sub_drunken%20master_xge=b1) or [***Flurry of Blows***](https://5e.tools/classes.html#monk_xphb,state:sub_drunken%20master_xge=b1), you may teleport up to **10 feet** to an unoccupied space you can see as part of that action.
