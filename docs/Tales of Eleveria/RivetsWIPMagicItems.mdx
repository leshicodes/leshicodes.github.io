...
|--------------|----------------|-------------------|------------------|----------------|
| [Rivet's Astral Wraps](#rivets-astral-wraps) | Rare *(requires attunement by a Monk)* | Theoretical | TBD | Pending |
{/* | [Windlash Bandolier](#windlash-bandolier) | Very Rare *(requires attunement by a Monk)* | Theoretical | Blackened mithril, Dwarven leather, Arcane pulleys | Pending | */}
...
#### Suggestions from Gio / Blaze
"i love it! patient defense gives me the dodge action so its a little jumbled. If i could suggest an edit:"
    * (1/day) Slipstream - *Step of the Wind* gains Sanctuary and advantage on my next unarmed strike. 
    * Momentum (or another name) - *Patient Defense* gains +1AC and immediately move 10' without provoking opp attacks


#### Questions for DM
* TBD */}

### Rivet's Astral Wraps
...
#### Concept Description
> *These hand and wrist wraps are crafted from pale-blue astral silk, banded with micro-filament threading and inlaid sigils that flicker with Rivet's signature arc light circuitry. They're laced at the seams with crimson trim, a nod to Gio's monastic roots with the Order of St. Denier, while the shimmering body pulses like a still lake under moonlight.*
>
> *When worn, the wraps ripple faintly with every movement faint streaks of glowing blue trailing behind punches, blocks, and sidesteps like echoes of intent. They hum with barely contained energy, not loud but present, like breath before a strike. These are no common relics. They are tools of discipline, deception, and divine rebellion, engineered in silence and starlight.*

#### Proposed Features

**Astral Impact**  
Your unarmed strikes deal force damage instead of their normal type.

**Ki Blink**  
When you use [***Step of the Wind***](https://5e.tools/classes.html#monk_xphb,state:sub_drunken%20master_xge=b1) or [***Flurry of Blows***](https://5e.tools/classes.html#monk_xphb,state:sub_drunken%20master_xge=b1), you may move through a creature's space as though it were difficult terrain. 
    * You must end your movement in an unoccupied space. 
    * You do not provoke opportunity attacks from that creature during this movement.

**Afterimage Drift**  
When you activate ***Patient Defense***, you gain a **+1 bonus to AC** until the start of your next turn.
Additionally, you may immediately move up to **10 feet** without provoking opportunity attacks. This movement does not count against your movement for the turn.


**Astral Convergence (1/day)**  
As a bonus action, you may cast [***Mirror Image***](https://5e.tools/spells/mirror-image-xphb.html) on yourself.
    * No components are required.
    * This version does not require concentration.
    * The illusory duplicates mimic your erratic monk style, trailing constellations as they shift and shimmer in astral sync with your movements.

*"Unarmed doesn't mean unprepared."* - Rivet
...
**Development Phase:** Theoretical  
**Materials Needed:** 
- Blackened mithril links
- Reinforced dwarven leather
- Miniature arcane pulleys

#### Concept Description
Crafted from blackened mithril links and reinforced dwarven leather, lined with miniature arcane pulleys that magnetize and recall spiked projectiles. Strapped across Gio's chest, the Windlash Bandolier holds several of his explosive mithril spikes in seamless clasps. Each clasp is wired with tiny retractable filaments that shimmer like fine lightning thread—allowing split-second spike return with a resonant hum. Runes along the leather shift between dwarven script and shifting monk glyphs as he moves.

#### Proposed Features

**Slipstream Circuit** *(1/day)*  
When you activate *Step of the Wind*, you may also activate Slipstream:  
* You gain the effects of Sanctuary (DC = 8 + proficiency bonus + Wisdom modifier) until the start of your next turn.
* Your next unarmed strike before the end of your turn has advantage.
* While Slipstream is active, your movement leaves behind a brief shimmer of echoing steps—purely visual.

*"You move too fast for consequence to catch you." —Rivet, proudly watching from the rafters.*

**Momentum Pulse** *(Passive Augmentation)*  
When you use *Patient Defense*, you also:  
* Gain +1 AC until the start of your next turn.
* May immediately move 10 feet without provoking opportunity attacks. (This movement is part of the same bonus action used for *Patient Defense*.)

*"Defense is just offense in reverse." —M.E.R.L.I.N., smugly*

**Optional Flair** *(No mechanics impact, but full flavor)*
* When you throw a mithril spike, the Bandolier auto-recalls it with a small arc of force. It makes a satisfying clink as it docks.
* If a spike is ever "lodged" in an enemy (for RP/description), it rips free on recall with a flash of displaced air. */}
