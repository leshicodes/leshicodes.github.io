...
flowchart TD
    ...
    subgraph "Music Acquisition"
        Lidarr["🎵 Lidarr<br/>Music Library Manager"] --> NZBGet["📥 NZBGet<br/>Download Client"]
        NZBGet --> |Downloads| MusicFiles[("💿 Music Files<br/>(FLAC/MP3)")]
    end
    ...
    %% Apply classes
    class Lidarr,NZBGet,MusicFiles acquisition
...
My setup uses [NZBGet](https://hub.docker.com/r/linuxserver/nzbget) integrated with Lidarr for handling downloads of content I've purchased. Both services run in Docker containers and are NOT exposed to the internet for security.
